...
const CoinCard = ({ coinName, symbol, priceUsd, percentChange24h }) => {
	return (
		<View style={Style.container}>
			...
			<View style={{ flexDirection: 'column', justifyContent: 'flex-end', alignContent: 'center' }}>
				...
				<Text>
					24h:
					<Text style={percentChange24h < 0 ? Style.percentChangeMinus : Style.percentChangePlus}>
						{' '}
						{percentChange24h} %{' '}
					</Text>
				</Text>
